...
class LibrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create libro" do
    assert_difference('Libro.count') do
      post libros_url, params: { libro: { autor: @libro.autor, editoria: @libro.editoria, genero: @libro.genero, isbn: @libro.isbn, nombre: @libro.nombre } }
    end
  ...
  test "should update libro" do
    patch libro_url(@libro), params: { libro: { autor: @libro.autor, editoria: @libro.editoria, genero: @libro.genero, isbn: @libro.isbn, nombre: @libro.nombre } }
